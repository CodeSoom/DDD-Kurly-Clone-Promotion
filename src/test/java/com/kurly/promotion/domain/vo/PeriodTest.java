...
class PeriodTest {
    ...
    void create() {
        ...
        final com.kurly.promotion.domain.vo.Period period = new com.kurly.promotion.domain.vo.Period(startDate, endDate);
    ...
    void start_date_after_end_date() {
        ...
        assertThatCode(() -> com.kurly.coupon.domain.Period.createPeriod(startDate, endDate))

...
class DiscountControllerTest {
    ...
    private DiscountRegisterData invalidDiscountRegisterData;
    ...
    void setUp() {
        ...
        invalidDiscountRegisterData = DiscountRegisterData.builder()
                .productId(1L)
                .flatRate(101)
                .build();
    }
    ...
    void registerWithValidDiscountRegisterData() throws Exception {
        given(discountService.registerDiscount(any(DiscountRegisterData.class)))
                .willReturn(registeredId);

        mockMvc.perform(post("/discounts")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(discountRegisterData)))
    ...
    void registerWithInValidDiscountRegisterData() throws Exception {
        mockMvc.perform(post("/discounts")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(invalidDiscountRegisterData)))
